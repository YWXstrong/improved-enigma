    ...
    <div className="App">
      <header className="App-header" style={{
        ...
        <div className="image-selector">
          <label htmlFor="bg-image" className="image-upload-btn">选择背景图片</label>
          <input
            id="bg-image"
            type="file"
            accept="image/*"
        ...
        {/* 可编辑介绍文本 */}
        <div className="interactive-box intro-box" onClick={handleIntroEdit}>
          {isEditingIntro ? (
            <textarea
              value={introText}
          ...
          {!isEditingIntro && <div className="edit-hint">点击编辑介绍</div>}
        </div>
